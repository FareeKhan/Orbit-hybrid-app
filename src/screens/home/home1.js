...
const Home1 = ({ navigation, homeActions }) => {
          ...
          <ScrollView
            ...
            <View style={{ flex: 1, width: wp('92%'), alignItems: 'center' }}>
              ...
              <View style={{ marginTop: 70, width: '100%' }} >
                <Text style={[styles.topText, { fontSize: RFValue(34), color: '#39475d' }]}>{"Mobile Recharge To All Your Friends & Family"}</Text>
              </View>
              {NumberBox()}
              {/* <NumberBox/> */}
              {showList &&
              ...
              <View style={{ marginTop: 80, width: '100%' }} >
                <Text style={styles.bottomText}>Orbit delivers mobile Recharges to <Text style={{ fontWeight: '700' }}>500+ mobile operators</Text> across the globe</Text>
              </View>
