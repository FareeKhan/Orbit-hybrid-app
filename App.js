...
import messaging from '@react-native-firebase/messaging';
 ...
 import TermsPolicy from './src/screens/TermsPolicy/Index'
   ...
   return (
    ...
    <StripeProvider
     ...
     // urlScheme="your-url-scheme" // required for 3D Secure and bank redirects
      merchantIdentifier={Platform.OS == 'ios'?"merchant.com.orbitrecharge":"com.orbit"} // required for Apple Pay
    >
           ...
           <StatusBar backgroundColor='rgba(0, 0, 0, 0.6)'></StatusBar>
             <NavigationContainer>
              ...
              /> */}
               ...
               <Stack.Screen name="RemitForm" component={RemitForm} options={{ headerShown: false }}/>
               <Stack.Screen name="RemitPay" component={RemitPay} options={{ headerShown: false }}/>
               <Stack.Screen name="My_Account" component={My_Account} options={{ headerShown: false }}/>
               <Stack.Screen name="SMS_Package" component={SMS_Package} options={{ headerShown: false }}/>
               <Stack.Screen name="SMSHistory" component={SMSHistory} options={{ headerShown: false }}/>
               ...
               <Stack.Screen name="RequestDashboard" component={RequestDashboard} options={{ headerShown: false }}/>
               <Stack.Screen name="RemitDashboard" component={RemitDashboard} options={{ headerShown: false }}/>
               <Stack.Screen name="SentDetails" component={SentDetails} options={{ headerShown: false }}/>
               <Stack.Screen name="RecieveDetails" component={RecieveDetails} options={{ headerShown: false }}/>
               <Stack.Screen name="Buy_SMS" component={Buy_SMS} options={{ headerShown: false }}/>
               <Stack.Screen name="RequestPlans" component={RequestPlans} options={{ headerShown: false }}/>
               <Stack.Screen name="RequestSubmit" component={RequestSubmit} options={{ headerShown: false }}/>
               <Stack.Screen name="RequestSuccess" component={RequestSuccess} options={{ headerShown: false }}/>
               <Stack.Screen name="FAQ" component={FAQ} options={{ headerShown: false }}/>
               <Stack.Screen name="FBpage" component={FBpage} options={{ headerShown: false }}/>
               <Stack.Screen name="Contact" component={Contact} options={{ headerShown: false }}/>
               <Stack.Screen name="SetPin" component={SetPin} options={{ headerShown: false }}/>
               <Stack.Screen name="Pin_Auth" component={Pin_Auth} options={{ headerShown: false }}/>
               <Stack.Screen name="Check_pin" component={Check_pin} options={{ headerShown: false }}/>
